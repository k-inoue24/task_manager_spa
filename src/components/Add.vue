<template>
  ...
  <transition name="fade">
    <section class="addTask" v-if="selectedDate!=null">
      <h2 class="title sectionTitle"><span ref="selectedDate">{{selectedDate}}</span>: <br class="s">タスク登録</h2>
  ...
  <transition name="fade">
    <section class="futureTask" v-if="selectedDate!=null">
      <h2 class="title sectionTitle"><span>{{selectedDate}}</span>: <br class="s">タスク一覧</h2>
